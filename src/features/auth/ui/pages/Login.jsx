    ...
    <div className='text-white flex flex-col gap-4'>
      ...
      <div className="middle">
        <form className='flex flex-col gap-3'>
          ...
          <button className='bg-[#20D760] p-2 font-bold rounded-3xl text-black'>Continue</button>
        </form>
      </div>
